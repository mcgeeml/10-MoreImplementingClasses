...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.temp_start = start.clone()
        self.temp_end = end.clone()
        # --------------------------------------------------------------
        # DONE: 3.
    ...
    def is_parallel(self, line2):
        ...
        if (self.end.x - self.start.x == 0):
            ...
            m1 = round(((self.end.y - self.start.y) / (self.end.x - self.start.x)), 12)

        if (line2.end.x - line2.start.x == 0):
            m2 =  math.inf
        else:
            m2 = round(((line2.end.y - line2.start.y) / (line2.end.x - line2.start.x)), 12)
